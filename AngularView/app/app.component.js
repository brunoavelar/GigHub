System.register(['angular2/core', 'angular2/http', 'angular2/router', 'rxjs/Rx', 'angular2/http/testing', './gigs/index', './nav-bar/nav-bar.component', './account/login.service', './account/login.component', './account/user-info', './account/logged-in-router-outlet', './shared/authorized.http', './api/fake.http'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, http_1, router_1, testing_1, index_1, nav_bar_component_1, login_service_1, login_component_1, user_info_1, logged_in_router_outlet_1, authorized_http_1, fake_http_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
                ...
                AppComponent = __decorate([
                    core_1.Component({
                        ...
                        providers: [index_1.GigService,
                            ...
                            fake_http_1.FakeHttp,
                            testing_1.MockBackend,
                            http_1.HTTP_PROVIDERS,
                            http_1.BaseRequestOptions,
                            core_1.provide(http_1.Http, {
                                useFactory: function (backend, defaultOptions) {
                                    return new fake_http_1.FakeHttp(backend, defaultOptions);
                                },
