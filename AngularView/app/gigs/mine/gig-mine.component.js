System.register(['angular2/core', 'angular2/router', '../list/attendance-button.component', '../gig.service', '../gigs-filter.pipe', "../gig-date.component"], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            GigMineComponent = (function () {
                function GigMineComponent(gigService) {
                    this.gigService = gigService;
                    this.searchTerm = '';
                }
                GigMineComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.gigService.getMyGigs()
                        .then(function (gigs) { return _this.gigs = gigs; })
                        .catch(function (error) { return console.log(error); });
                };
                GigMineComponent = __decorate([
                    core_1.Component({
                ...
                return GigMineComponent;
            }());
            exports_1("GigMineComponent", GigMineComponent);
        }
    }
});
//# sourceMappingURL=gig-mine.component.js.map